    ...
    return (
        <div className="demo-container">
            <div className="demo-box" style={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                ...
                <button className="btn-sm btn btn-dark"  onClick={()=>{dispatchCounterAction({type:'SUBTRACT',payload:parseInt(inputRef?.current?.value?inputRef?.current?.value:'0')})}}>Subtract</button>
